...
pub use ir::{
    ...
    EmitProgram, EmitPropBinding, EmitPropsPlan, EmitSlotId, EmitTemporary, EmitTemporaryId,
    EmitValueRef, PropsOperation, ReactiveSlot, ReactiveSlotKind, ReactiveSlotStorage,
    RuntimeImportIntent,
};
