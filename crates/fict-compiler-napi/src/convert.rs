use fict_compiler::{
    CompileRequest, CompileResult, ScanRequest, ScanResult, invalid_request_result,
    invalid_scan_request_result,
};
...
mod tests {
    ...
    use super::{CompileWork, ScanWork, prepare_compile, prepare_scan};
