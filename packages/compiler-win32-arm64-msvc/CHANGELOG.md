...
- Ship the 0.34 native compiler for Windows arm64 MSVC with frontend reuse, faster alias analysis,
...
- Publish the capability-identified and frozen-corpus-certified Rust compiler for Windows arm64 MSVC.
