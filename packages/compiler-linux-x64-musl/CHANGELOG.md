...
- Ship the 0.34 native compiler for Linux x64 musl with frontend reuse, faster alias analysis,
...
- Ship the 0.33 native compiler for Linux x64 musl with module-qualified resume registration,
...
- Publish the capability-identified and frozen-corpus-certified Rust compiler for Linux x64 musl.
