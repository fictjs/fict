...
| Standard decorators                      | Parsed and preserved by pinned OXC, leaving syntax that supported Node targets cannot execute               | OXC compatibility gate          | Reject until a target-compatible runnable lowering is connected            |
